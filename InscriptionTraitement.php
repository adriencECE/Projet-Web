...
if(isset($_POST["Prenom"])){$Prenom=$_POST["Prenom"];}
    ...
    $Prenom = "";}  
if(!isset($_POST["Tel"])){$toutRempli = false;}  else{$Tel=$_POST["Tel"];}
if(!isset($_POST["Mail"])){$toutRempli = false;}   else{$Mail=$_POST["Mail"];}
if(!isset($_POST["Adresse"])){$toutRempli = false;}   else{$Adresse=$_POST["Adresse"];}
if(!isset($_POST["NumCarteVitale"])){$toutRempli = false;}   else{$NumCarteVitale=$_POST["NumCarteVitale"];}
if(!isset($_POST["NumeroCarte"])){$toutRempli = false;}   else{$NumeroCarte=$_POST["NumeroCarte"];}
if(!isset($_POST["TypeCarte"])){$toutRempli = false;}   else{$TypeCarte=$_POST["TypeCarte"];}
if(!isset($_POST["DateExpiration"])){$toutRempli = false;}   else{$DateExpiration=$_POST["DateExpiration"];}
if(!isset($_POST["CodeCarte"])){$toutRempli = false;}    else{$CodeCarte=$_POST["CodeCarte"];}
